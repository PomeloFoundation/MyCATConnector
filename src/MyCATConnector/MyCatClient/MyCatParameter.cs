...
{
	public sealed class MyCatParameter : DbParameter
	{
		...
		internal MyCatParameter WithParameterName(string parameterName) => new MyCatParameter(this, parameterName);

		private MyCatParameter(MyCatParameter other, string parameterName)
		{
			DbType = other.DbType;
