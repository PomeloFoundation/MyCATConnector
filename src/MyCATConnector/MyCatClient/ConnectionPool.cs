...
namespace MyCat.Data.MyCatClient
{
	...
	{
		public async Task<MyCatSession> GetSessionAsync(IOBehavior ioBehavior, CancellationToken cancellationToken)
		{
			...
			try
			{
				...
				session = new MyCatSession(this, m_generation);
		...
		public void Return(MyCatSession session)
		{
			try
			{
		...
		private ConnectionPool(ConnectionSettings cs)
		{
			...
			m_sessions = new ConcurrentQueue<MyCatSession>();
		}
		...
		readonly ConcurrentQueue<MyCatSession> m_sessions;
